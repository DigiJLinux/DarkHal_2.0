...
class SingleThreadedAgentRuntime(AgentRuntime):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from agentdhal_core import AgentId, MessageContext, RoutedAgent, SingleThreadedAgentRuntime, message_handler
    ...
    async def save_state(self) -> Mapping[str, Any]:
        ...
        This method calls the :meth:`~agentdhal_core.BaseAgent.save_state` method on each agent and returns a dictionary
    ...
    async def load_state(self, state: Mapping[str, Any]) -> None:
        ...
        This method calls the :meth:`~agentdhal_core.BaseAgent.load_state` method on each agent with the state
        provided in the dictionary. The keys of the dictionary are the agent IDs, and the values are the state
        dictionaries returned by the :meth:`~agentdhal_core.BaseAgent.save_state` method.
    ...
    def start(self) -> None:
        ...
        .. code-block:: python
            ...
            import asyncio
            from agentdhal_core import SingleThreadedAgentRuntime
